...
export const MOCK_SHIPMENTS: any[] = [
  {
    ...
    status: ShipmentStatus.TRANSITO,
    dianStatus: 'emitido',
  ...
  },
  {
    ...
    status: ShipmentStatus.RECIBIDA_OFICINA_INTERMEDIA,
    dianStatus: 'emitido',
  ...
  },
  {
    ...
    status: ShipmentStatus.RECIBIDA_OFICINA_DESTINO,
    dianStatus: 'emitido',
  ...
  },
  {
    ...
    status: ShipmentStatus.ENTREGADA_CUMPLIDA,
    dianStatus: 'emitido',
  ...
  },
  {
    ...
    status: ShipmentStatus.DEVUELTA_OFICINA_DESTINO,
    dianStatus: 'emitido',
